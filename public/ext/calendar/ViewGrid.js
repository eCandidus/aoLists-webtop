...
Ext.ux.go.grid.ViewGrid = Ext.extend(Ext.Panel, {
	/**
    ...
    initComponent : function(){
        Ext.ux.go.grid.ViewGrid.superclass.initComponent.call(this);
	...
	onRender : function(ct, position){
		...
		Ext.ux.go.grid.ViewGrid.superclass.onRender.apply(this, arguments);
	...
	initDD :  function(){
		...
		var dragZone = new Ext.ux.go.calendar.dd.ViewDragZone(this.body, {
            ddGroup: 'view-grid',
            scroll: false,
            viewGrid: this
        });
        
    var dropTarget = new Ext.ux.go.calendar.dd.ViewDropTarget(this.body, {
        ddGroup: 'view-grid',
  	...
  	Ext.Ajax.request({
  		url: Ext.ux.go.settings.modules.calendar.url+'json.php',
			...
			callback: function(options, success, response)
			{
				...
				if(!success)
				{
					Ext.MessageBox.alert(Ext.ux.go.lang.strError, response.result.feedback);
				}else
				{					
  ...
  elementToEvent : function(elementId, allDay)
    ...
    destroy : function(){
		...
		Ext.ux.go.grid.CalendarGrid.superclass.destroy.call(this);
...
Ext.ux.go.calendar.dd.ViewDragZone = function(el, config) {
    config = config || {};
    Ext.apply(config, {
        ddel: document.createElement('div')
    });
    Ext.ux.go.calendar.dd.ViewDragZone.superclass.constructor.call(this, el, config);
};
 
Ext.extend(Ext.ux.go.calendar.dd.ViewDragZone, Ext.dd.DragZone, {
	...
	afterRepair : function(){
		Ext.ux.go.calendar.dd.ViewDragZone.superclass.afterRepair.call(this);
...
Ext.ux.go.calendar.dd.ViewDropTarget = function(el, config) {
    Ext.ux.go.calendar.dd.ViewDropTarget.superclass.constructor.call(this, el, config);
};
Ext.extend(Ext.ux.go.calendar.dd.ViewDropTarget, Ext.dd.DropTarget, {
