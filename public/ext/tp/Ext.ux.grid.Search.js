 ...
 */
 ...
 Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
     ...
     /**
     * @cfg {String} defaultSearch Start the search with this value (defaults to undefined)
     */
     defaultSearch: null

     /**
     * @cfg {Boolean} autoFocus Try to focus the input field on each store load if set to true (defaults to false)
     */
     , autoFocus: false
