 ...
 *
 */
my.Functions.EXList = function (src) {
...
my.Tools.External = function (src, cb) {
    my.AJAX.call('GetEX', src, function (result) {
        if (result && result.data) {
            my.Functions.EXList(result.data);
        }
    });
};