...
exports.send = function (req, res, credentials, values) {
    if (aofn.hasValue(values.uname)) {
        ...
        if (aofn.hasValue(values.upwd)) {
            aofn.serverCall(credentials, aofn.formatURL('/users/{0}/{1}', values.uname, values.upwd), function (response) {
                aofn.serverCall(credentials, aofn.formatURL('/users/{0}/metadata/set', values.uname), {
