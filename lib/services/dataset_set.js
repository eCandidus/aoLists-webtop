...
exports.send = function (req, res, credentials, values) {
    ...
    if (ds) {
        aofn.serverCall(credentials, aofn.format('/{0}/{1}/metadata', ds[0], ds[1]), function (response) {
            response = aofn.mergeRecursive(response, values);
            aofn.serverCall(credentials, aofn.format('/{0}/{1}/metadata', ds[0], ds[1]), response, function (response) {
